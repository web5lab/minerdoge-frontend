...
export const taskSelector = createSelector([gameSelector], (game) => game.task);

export const RankSelector = createSelector([gameSelector], (game) => game.rank);
...
export const secretCodeSelector = createSelector(
  [gameSelector],
  (game) => game.secretCode
);

export const referalNotificationSelector = createSelector(
  [gameSelector],
  (game) => game.referalNotification
)
export const dailyNotificationSelector = createSelector(
  [gameSelector],
  (game) => game.dailyNotification
);
